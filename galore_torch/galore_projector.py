...
class GaLoreProjector:
    def __init__(self, rank, verbose=False, update_proj_gap=200, scale=1.0, proj_type='std', method='probabilistic'):
        self.rank = rank
    ...
    # svd decomposition
    def get_orthogonal_matrix(self, weights, rank, type, method='probabilistic'):
